...
- 登録済み場所のワンタップ反映（自宅 / 実家 / 勤務先 / よく行く場所）
...
- トップページ背景テーマの選択（青空 / 夕焼け / 夜空 / ミント）
  - トップ・日記作成・見返す（カレンダー／地図）・詳細・読む の枠内デザインに反映
...
設定で住所が入っている項目だけ、日記を書くページにボタンが表示されます。
...
ボタン押下、または場所欄に上記の名称を入力すると、登録住所と地図に反映されます。保存時も住所が保存されます。
